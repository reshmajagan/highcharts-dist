...
a=a.seriesType;a("roc","sma",{params:{index:3,period:9}},{nameBase:"Rate of Change",getValues:function(a,b){var d=b.period,h=a.xData,g=(a=a.yData)?a.length:0,k=[],l=[],m=[],e=-1,c;if(h.length<=d)return!1;f(a[0])&&(e=b.index);for(b=d;b<g;b++)c=0>e?(c=a[b-d])?(a[b]-c)/c*100:null:(c=a[b-d][e])?(a[b][e]-c)/c*100:null,c=[h[b],c],k.push(c),l.push(c[0]),m.push(c[1]);return{values:k,xData:l,yData:m}}})});b(a,"masters/indicators/roc.src.js",[],function(){})});
