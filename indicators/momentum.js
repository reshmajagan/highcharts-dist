...
b,c,f,d){c=c[f-1][3]-c[f-d-1][3];b=b[f-1];a.shift();return[b,c]}var h=b.isArray;a=a.seriesType;a("momentum","sma",{params:{period:14}},{nameBase:"Momentum",getValues:function(a,b){b=b.period;var c=a.xData,f=(a=a.yData)?a.length:0,d=c[0],k=[],l=[],m=[],n,e;if(c.length<=b||!h(a[0]))return!1;n=[[d,a[0][3]]];for(d=b+1;d<f;d++)e=g(n,c,a,d,b,void 0),k.push(e),l.push(e[0]),m.push(e[1]);e=g(n,c,a,d,b,void 0);k.push(e);l.push(e[0]);m.push(e[1]);return{values:k,xData:l,yData:m}}})});b(a,"masters/indicators/momentum.src.js",
[],function(){})});
