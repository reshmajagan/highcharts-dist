...
a[2],d===h?0:Math.abs(a[1]-d[3]),d===h?0:Math.abs(a[2]-d[3]))}var k=b.isArray;a=a.seriesType;var h;a("atr","sma",{params:{period:14}},{getValues:function(a,d){d=d.period;var b=a.xData,h=(a=a.yData)?a.length:0,l=1,f=0,q=0,m=[],n=[],p=[],e,c,r;r=[[b[0],a[0]]];if(b.length<=d||!k(a[0])||4!==a[0].length)return!1;for(c=1;c<=h;c++)if(r.push([b[c],a[c]]),d<l){e=d;var t=b[c-1],u=g(a[c-1],a[c-2]);e=[t,(f*(e-1)+u)/e];f=e[1];m.push(e);n.push(e[0]);p.push(e[1])}else d===l?(f=q/(c-1),m.push([b[c-1],f]),n.push(b[c-
