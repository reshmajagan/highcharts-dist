...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/oldie.src.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
         ...
         *
         * */
        var isArray = U.isArray, isNumber = U.isNumber, pInt = U.pInt;
        var VMLRenderer, VMLRendererExtension, VMLElement, Chart = H.Chart, createElement = H.createElement, css = H.css, defined = H.defined, deg2rad = H.deg2rad, discardElement = H.discardElement, doc = H.doc, erase = H.erase, extend = H.extend, extendClass = H.extendClass, isObject = H.isObject, merge = H.merge, noop = H.noop, pick = H.pick, svg = H.svg, SVGElement = H.SVGElement, SVGRenderer = H.SVGRenderer, win = H.win;
        /**
        ...
        H.getOptions().global.VMLRadialGradientURL =
            'http://code.highcharts.com/7.1.2-modified/gfx/vml-radial-gradient.png';
        // Utilites
